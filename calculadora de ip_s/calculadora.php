...
echo "Quantidade de sub-redes: ".qtd_de_sub_redes($sub_rede)."<br><br>".
     "Quantidade de endereços por sub-rede: " .qtd_de_enderecos($sub_rede)."<br><br>".
     "Quantidade de endereços de hosts em cada sub-rede: ".qtd_de_host($sub_rede)."<br><br>".
     "Primeiro endereço de host da sub-rede em que o endereço IP informado se encontra: " .pri_host_ip_infor($sub_rede)."<br><br>".
     "Último endereço de host da sub-rede em que o endereço IP informado se encontra: ".uti_host_ip_infor(broadcast_ip_infor($localhost,$sub_rede))."<br><br>".
     "Endereço de broadcast da sub-rede em que o endereço informado se encontra: ".broadcast_ip_infor($localhost,$sub_rede)."<br><br>".
     "Máscara da rede, em formato decimal: ".mascara_decimal($sub_rede)."<br><br>".
     "Classe a que o IP pertence: ".classe_ip()."<br><br>".
     "IP é público ou privado: ".ip_privado($ip_privados)."<br><br>";
